...
| `snapping`           | `True`         | Snap the provided watershed outlet to a stream on the raster data grid. An alternative for those who wish to implement a custom snapping routine.                            |
