...
I wrote this to help benchmark different delineation methods.

TauDEM reports the run time
...
# I set up .csv files for 27 (Iceland), 23 (Western Europe), and 62 (Amazon)
megabasin = 11
...
def make_gage_shapefile():
    ...
    infile = f"outlets{megabasin}.csv"
    outfile = f"shp/outlets{megabasin}.shp"
...
def snap_gages():
    ...
    :return:
    """
    outlets = f"shp/outlets{megabasin}.shp"
    outlets_snapped = f"shp/outlets{megabasin}_snapped.shp"
...
def delineate() -> bool:
    ...
    infile = f'shp/outlets{megabasin}_snapped.shp'
    ...
    for i in range(0, n):
        ...
        elapsed_time, result = run_taudem()
...
if __name__ == "__main__":
    ...
    results_df.to_csv(f"taudem_results{megabasin}.csv")
