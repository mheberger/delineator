...
Intersect a series of shapefiles to determine the percent overlap. 
...
for i in range(0, n):
    gage_id = gage_ids[i]
    print(gage_id)
    fname1 = "C:/Users/mheberger/Documents/delineator/paper/watersheds/usgs/gid_{}.shp".format(gage_id)
    fname2 = "C:/Users/mheberger/Documents/delineator/paper/watersheds/esri/gid_{}.shp".format(gage_id)

    intersect = "{}.shp".format(gage_id)
    ...
    layer = QgsVectorLayer(intersect, '', 'ogr')
...
csv_file = "../intersect_areas.csv"

csv_columns = ('gage','intersect_area')
f = open(csv_file, 'w')
