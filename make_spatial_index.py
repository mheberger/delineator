...
fname = r'C:\Users\mheberger\AppData\Local\delineator\vector\megabasins2.db'
...
rows = [
    (row['BASIN'], row['continent'], shapely.to_wkb(to_multi(row.geometry)))
